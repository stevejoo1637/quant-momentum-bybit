# ==========================================
# Quant Momentum v3.3R – VPN Proxy Safe Edition
# ------------------------------------------
# ✅ Render Singapore + Proxy 환경에서 안정 실행
# ✅ 신호 감지 + 로그 + 자동재시도
# ❌ 실제 거래 없음 (create_order 주석처리)
# ==========================================
...
# Proxy (VPN) 설정
# ==========================================
# ⚠️ 아래 주소는 예시입니다. 본인 Proxy로 교체하세요.
...
def execute_trade(symbol, signal, price):
    ...
    ------------------------------------
    """
    print(f"🚀 [{signal}] {symbol} | 현재가 {price:.2f}")

# ==========================================
# 메인 루프
# ==========================================
print(f"🚀 Quant Momentum v3.3R (Proxy Edition) 시작됨 | UTC {datetime.utcnow().strftime('%Y-%m-%d %H:%M:%S')}")
